...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_inscriptions_vue__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_inscriptions_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_inscriptions_vue__);
/*
...
Vue.component('inscriptions', __WEBPACK_IMPORTED_MODULE_0__components_inscriptions_vue___default.a);
...
Component.options.__file = "resources/assets/js/components/inscriptions.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2ff7f09c", Component.options)
  } else {
    hotAPI.reload("data-v-2ff7f09c", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__inscriptions_presencial_vue__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__inscriptions_online_vue__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__payments_payments_vue__ = __webpack_require__(17);
...
Component.options.__file = "resources/assets/js/components/inscriptions/presencial.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ae55a8d2", Component.options)
  } else {
    hotAPI.reload("data-v-ae55a8d2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("div", [
    _c("h2", [_vm._v("Inscripciones")]),
    _vm._v(" "),
    _c("form", { attrs: { action: "/admin/inscriptions", method: "post" } }, [
      _c("input", {
      ...
      _c(
        ...
        [
          _c("label", { staticClass: "col-2" }, [_vm._v("Ciudad")]),
          _vm._v(" "),
          _c(
            "select",
            {
          ...
          _vm._l(_vm.events, function(event) {
            return _c("div", { key: event.id, staticClass: "col-12 row" }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                ...
                attrs: { type: "checkbox", name: "events[]" },
                domProps: {
                  value: event.id,
                  checked: Array.isArray(_vm.selected)
                    ? _vm._i(_vm.selected, event.id) > -1
                    : _vm.selected
                },
                on: {
                  change: function($event) {
              ...
              _vm._v(" "),
              _c("label", { staticClass: "col-11", attrs: { for: "" } }, [
                _c("b", [_vm._v("  " + _vm._s(event.seminar.title))]),
                _vm._v(
                  " / " +
                    _vm._s(event.state) +
                    " - " +
      ...
      _c("div", { staticClass: "row" }, [
        _c(
          "button",
          {
            staticClass: "button btn-lg btn-outline-info col-4 offset-2",
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "form-group row" }, [
      _c("label", { staticClass: "col-2" }, [_vm._v("Nombre -de facebook-")]),
      _vm._v(" "),
      _c("input", {
        staticClass: "form-control col-4",
        attrs: { required: "", type: "text", name: "fbname" }
      })
    ])
  },
  function() {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ae55a8d2", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/inscriptions/online.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-523c7280", Component.options)
  } else {
    hotAPI.reload("data-v-523c7280", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
      ...
      _c(
        ...
        _vm._l(_vm.events, function(event) {
          return _c("div", { key: event.id, staticClass: "col-12 row" }, [
            ...
            _c("label", { staticClass: "col-11", attrs: { for: "" } }, [
              _c("b", [_vm._v("  " + _vm._s(event.seminar.title))]),
              _vm._v(" /ONLINE/ " + _vm._s(event.date))
            ])
          ])
        })
      ),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__create__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__list__ = __webpack_require__(22);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        'pay-create': __WEBPACK_IMPORTED_MODULE_1__create___default.a,
        'pay-list': __WEBPACK_IMPORTED_MODULE_2__list___default.a
    },
    data: function data() {
        return {
    ...
    created: function created() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__app_js__["EventBus"].$on('refreshData', function () {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        cancelInscription: function cancelInscription(inscription) {
            var revisionPay = inscription.payments.find(function (el) {
                return el.status == 'revision';
            });
            if (revisionPay == null) {
                $.ajax({
                    method: 'delete',
  ...
  return _c("div", { staticClass: "row border-dark" }, [
    ...
    _vm.user.wallet > 0
      ? _c("div", { staticClass: "row col-12" }, [
          _c(
            "span",
            { staticClass: "text-success font-weight-bold offset-2" },
            [_vm._v(" SALDO A FAVOR : $ " + _vm._s(_vm.user.wallet) + " ")]
          )
        ])
      : _vm._e(),
    _vm._v(" "),
                          ...
                          return _c("tr", { key: inscription.id }, [
                            ...
                            _c("td", [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "button btn-sm btn-outline-danger novalidate",
                                  attrs: { formnovalidate: "" },
                                  on: {
                                    click: function($event) {
                                      $event.stopPropagation()
                                      $event.preventDefault()
                                      _vm.cancelInscription(inscription)
                                    }
                                  }
                                },
...
Component.options.__file = "resources/assets/js/components/payments/list.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5bb83db9", Component.options)
  } else {
    hotAPI.reload("data-v-5bb83db9", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        changeStatus: function changeStatus(key, status) {
            var vm = this;
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.payments && _vm.payments.length > 0
    ? _c("div", [
        _c("h2", [_vm._v("Historial de pagos")]),
        _vm._v(" "),
        _c("table", { staticClass: "table table-striped" }, [
          ...
          _c(
            "tbody",
            _vm._l(_vm.payments, function(pay, key) {
              return _c("tr", { key: pay.id }, [
                _c("td", [
                  _vm._v(
                    "\n                     " +
                      _vm._s(pay.created_at) +
                      "\n                 "
                  )
                ]),
                _vm._v(" "),
                _c(
                  "td",
                  { staticClass: "row" },
                  _vm._l(pay.inscriptions, function(inscription) {
                    return _c(
                      "span",
                      { key: inscription.id, staticClass: "col-12" },
                      [
                        _c("b", [
                          _vm._v(
                            " " + _vm._s(inscription.event.seminar.title) + " "
                        ...
                        _vm._v(" /\n                            "),
                        inscription.event.mode == "presencial"
                          ? _c("span", [
                              _vm._v(
                                " /\n                                " +
                                  _vm._s(inscription.event.state) +
                        ...
                        _vm._v("/\n                            "),
                        _c("span", [_vm._v(_vm._s(inscription.event.date))])
                      ]
                    )
                  })
                ),
                ...
                _c("td", [
                  pay.ticket
                    ? _c("img", { attrs: { src: pay.ticket, alt: pay.ticket } })
                    : _vm._e()
                ]),
                _vm._v(" "),
                _c("td", [
                  _c("div", { staticClass: "row d-flex flex-column" }, [
                    pay.status == "revision"
                      ? _c(
                          "button",
                          {
                            staticClass: "button btn-sm btn-outline-warning",
                            class: {
                              "btn-warning text-white": pay.status == "revision"
                            },
                            on: {
                              click: function($event) {
                                _vm.changeStatus(key, "revision")
                              }
                            }
                          },
                          [_vm._v("Revision")]
                    ...
                    pay.status != "cancelado"
                      ? _c(
                          "button",
                          {
                            staticClass: "button btn-sm btn-outline-success",
                            class: {
                            ...
                            on: {
                              click: function($event) {
                                _vm.changeStatus(key, "confirmado")
                              }
                            }
                          },
                          [_vm._v("Confirmado")]
                    ...
                    pay.status != "confirmado"
                      ? _c(
                          "button",
                          {
                            ...
                            class: {
                              "btn-danger text-white": pay.status == "cancelado"
                            },
                            on: {
                              click: function($event) {
                                _vm.changeStatus(key, "cancelado")
                              }
                            }
                          },
                          [_vm._v("Cancelado")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5bb83db9", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm.user
        ? _c("pay-list", { staticClass: "mt-4", attrs: { user: _vm.user } })
        : _vm._e()
    ],
    1
  )
