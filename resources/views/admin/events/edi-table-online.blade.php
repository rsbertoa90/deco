            ...
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <div class="" id="online-event-tables-container">
                        ...
                        <table id="online-events-table" class="table table-striped m-b-0">
                            <thead>
                             <tr>
                               <th>
                                   Seminario
                            ...
                            <tbody>
                                @foreach (App\Event::future('online') as $event)
                        ...
                        <div class="row">
                            <button class="button btn-lg btn-default ml-3 btn-outline-info " id="online-create-event">
                                Crear Evento
                            </button>
                        </div>
                    </div>
